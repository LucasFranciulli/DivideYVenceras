...
import { Button, FlatList, Modal, Pressable, TextInput, View } from "react-native";
...
type GroupViewScreenRouteProp = RouteProp<
  RootStackParamList,
  'GroupView'
>;
...
export const GroupViewScreen = () => {
    ...
    return <View style={stylesViewGroup.container}>
        ...
        >
            ...
            <View style={stylesViewGroup.modalContent}>
                <Text style={stylesViewGroup.modalTitle}>¿A quién deseas agregar?</Text>
                <TextInput
